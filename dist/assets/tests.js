...
define('library-app/tests/helpers/module-for-acceptance', ['exports', 'qunit', 'ember', 'library-app/tests/helpers/start-app', 'library-app/tests/helpers/destroy-app'], function (exports, _qunit, _ember, _startApp, _destroyApp) {
  'use strict';
...
define('library-app/tests/helpers/start-app', ['exports', 'ember', 'library-app/app', 'library-app/config/environment'], function (exports, _ember, _app, _environment) {
  'use strict';
...
define('library-app/tests/integration/components/fader-label-test', ['ember-qunit'], function (_emberQunit) {
  ...
  (0, _emberQunit.test)('it renders', function (assert) {
    ...
    this.render(Ember.HTMLBars.template({
      "id": "E/K6hsN5",
      "block": "{\"statements\":[[1,[26,[\"fader-label\"]],false]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}",
      "meta": {}
    }));
    ...
    this.render(Ember.HTMLBars.template({
      "id": "ZPODTNYJ",
      "block": "{\"statements\":[[0,\"\\n\"],[6,[\"fader-label\"],null,null,{\"statements\":[[0,\"      template block text\\n\"]],\"locals\":[]},null],[0,\"  \"]],\"locals\":[],\"named\":[],\"yields\":[],\"hasPartials\":false}",
      "meta": {}
    }));
